<?php
function MostraTaulaSeleccioUsers()
{
?>
<div id="DIVFitxaSeleccioUsers" style=" position:fixed; top:0; left:0; width:100%; height:100%;  background:url(img/NegroTrans.png); display:none;"  onclick="TancaTablaUsuarisProc();">
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="center">
                ...
                <tr>
                    ...
                    <td width="200px" bgcolor="#FFFFFF">
                    	<div id="DIVTaulaSeleccioUsers" style="max-height:500px;overflow:auto"></div>
                    </td>
