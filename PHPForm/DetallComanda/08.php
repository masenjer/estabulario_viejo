...
//	{	
		$resultado = '<table cellpadding="5" border="0" cellspacing="0" style="border:1px solid #9e9885">
				<tr>
					...
					<td align="right" style="background-color:#444; color:#FFF"><input type="button" class="ButtonAdd24" onclick="MostraFitxaNewJaulasAnim('.$id.');"></td>
				</tr>
...
//	{	
		$resultado = '<table cellpadding="5" border="0" cellspacing="0" style="border:1px solid #9e9885">
				<tr>
					...
					<td align="right" style="background-color:#444; color:#FFF"><input type="button" class="ButtonAdd24" onclick="MostraFitxaNewJaulasJaula('.$id.');"></td>
				</tr>
				<tr class="CapcaGrid" align="left" style="text-align:left;">
					<td>Esp&egrave;cie</td>
					<td>Soca</td>
