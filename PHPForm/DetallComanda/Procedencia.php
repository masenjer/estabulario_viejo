...
function CarregaProcedencia($id)
{
	...
	while ($row = mysql_fetch_array($result))
	{
			$resultado .= ' 
			<tr>
				<td colspan="10" align="right" style="background-color:#444; color:#FFF">
					<input type="button" id="ButtonEditProcedencia" class="ButtonEdit24" onclick="EditProcedencia('.$row["IdProcedencia"].');">
				</td>
			</tr>
