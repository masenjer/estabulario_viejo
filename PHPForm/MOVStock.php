<?php
function MOVStockGuarda($idSoca, $NSM, $NSH,$FechaMOV,$TipusMOV,$IdProc,$DN,$IdCC){
	
	session_start();	
	include("../rao/EstabulariForm_con.php");

	$validado = ComprovaUnitatsPreMOV($idSoca, $TipusMOV, $NSM, $NSH, $IdProc, $DN);
...
function ComprovaUnitatsPreMOV($id, $RT, $NSM, $NSH, $NProc, $DN)
{
	...
	//echo "ComprovaStock(".$id.", ".$NProc.", ".$DN.", ".$res.")";
