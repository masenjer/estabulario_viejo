...
function MostraObservacions($id)
{
	...
	$resposta =  '<div style="alignment-adjust:right; width:100%; padding-bottom:10px;" align="right"><strong>Comentaris referents a la comanda '.$id.'</strong></div>';
...
//		
		...
		<table width="100%" cellpadding="5px" cellspacing="0" border="0">
			<tr>
				<td align="left" style="padding-top:15px" class="GridLine'.$i.'"><b>'.$row["Tecnic"].$row["Usuari"].' va escriure el dia '.SelectFecha($row["Fecha"]).'  a les '.$row["Hora"].':</b></td>
			</tr>
