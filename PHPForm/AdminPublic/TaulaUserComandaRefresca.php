...
$OrdreT = " ORDER BY CC.AvisU DESC, " .$Ordre[0]. $ASCDESC;
...
$SQL = "SELECT P.NumProc, CC.Fecha, CC.IdComandaCap, CC.TipusForm, CC.IdProcediment, CC.Facturada, U.Nom, U.Cognoms, CC.AvisU from  Users U,ComandaCap CC LEFT JOIN Procediment P ON (P.IdProcediment = CC.IdProcediment) WHERE U.IdUser = CC.IdUsuari AND CC.IdUsuari = " . $_SESSION["IdUser"] . $Filtre. $Coletilla . $FiltreText . $OrdreT;
