...
<table width="100%" cellpadding="5px" cellspacing="0" border="0">
	...
	<tr>
		<td colspan="3">'.CarregaHormouCrucesC($id).'</td>
	</tr>
	<tr>
		<td height="5px"></td>
	</tr>	
	<tr>
		<td colspan="3">'.CarregaRecollida($id,"1").'</td>
	</tr>	
	<tr>
...
function CarregaHormouCrucesC($id)
{
	...
	while ($row = mysql_fetch_array($result))
	{
		...
		if ($row["FS"] == 0) $resultado .= '<tr><td><b>No Separar </b></td></tr>';
		 ...
		 $resultado .= '
			<tr>
				<td style="padding-top:10px"><b>Estat de la comanda:&nbsp;&nbsp;</b>'. CarregaSelectEstat($row["IdHormoyCruces"],$row["Estado"],"HormoyCruces",$id).'</td>
			</tr>
			';
	}		
