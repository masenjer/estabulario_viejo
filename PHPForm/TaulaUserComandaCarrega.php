  ...
  <tr>	
	  <td id="TDRowComandes'.$row["IdComandaCap"].'"  onclick="SelectRowComanda('.$row["IdComandaCap"].');" style="cursor:pointer;" >
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
		  <tr >
			  <td width="110px" class="GridLine'.$i.'"><div style="width:110px" >'.SelectFecha($row["Fecha"]).'</div></td>
			  <td width="100px" class="GridLine'.$i.'"><div style="width:100px" >'.$row["IdComandaCap"].'</div></td>
			  
			  <td width="90px" class="GridLine'.$i.'"><div style="width:90px" >'.$row["NumProc"].'</div></td>
			  <td width="280px" class="GridLine'.$i.'"><div style="width:280px" >'.$TitolTipus.'</div></td>
			  
			  <td width="60px" class="GridLine'.$i.'"><div style="width:60px" ><input type="button" class="'.$class.'" value="'.$facturada.'"></div></td>
		  </tr>	
		</table>
	  </td>
  </tr>
