<?php
function CarregaCercaUsersWebValidat($Filtre)
{
	
	$CadenaFacturada = "";
	
	$r = array("Pendent","Denegat","Validat");
	
	$resultado =  '
	<div id="DIVUsersWebValidat" class="CercaSelect" style=" width:100px; display:none; height:80px; overflow:auto;" >
